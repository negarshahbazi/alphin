...
function LegendBuild() {
  ...
  const jantNoir = useSelector((state) => state.legend.jantNoir);
  ...
  const [currentJants, setCurrentJants] = useState(jantNoir); // Tableau d'images de jantes actuellement sélectionné
  ...
  const changeImages = (color) => {
    switch (color) {
      case 'blanc':
        ...
        setCurrentJants(jantsBlanc);
        break;
      case 'bleu':
        setCurrentImages(imagesBleu);
        setCurrentJants(jantsBleu);
        break;
      case 'noir':
        setCurrentImages(imagesNoire);
        setCurrentJants(jantNoir);
        break;
      default:
        setCurrentImages(imagesNoire);
        setCurrentJants(jantNoir);
    ...
    <>
      <section className='color backGround'>
        ...
        <div className=' m-0 p-0'>
          <div className=''  >
            <h1 className=''>Alpine A110 Legend Model Configurator</h1>
          </div>
            ...
            <div className='row'>
              ...
              <div className="col-md-6  container d-flex justify-content-center align-items-center ">
                <div className='row d-flex justify-content-center align-items-center text-center  mb-5' >
                  <h1>Jants</h1>
                  <div className='col-4 ' >
                    <img className='p-1' src={jant1} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => changeImages('blanc')} />
                    <span>Legende</span><br />
                    <b>0 €</b>
                  </div>
                  <div className='col-4'>
                    <img className='p-1' src={jant2} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => changeImages('bleu')} />
                    <span>Serac</span><br />
                    <b>1000 €</b>
                  </div>
                  <div className='col-4'>
                    <img className='p-1' src={jant3} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => changeImages('noir')} />
