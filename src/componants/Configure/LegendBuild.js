...
function LegendBuild() {
  ...
  const Perfpre = useSelector((state) => state.legend.prix[0].interieur.perfpre);
            ...
            <div className='row'>
              ...
              <div className="col-md-6  container d-flex justify-content-center align-items-center ">
                <div className='row d-flex justify-content-center align-items-center text-center  mb-5' >
                  ...
                  <div className='col-4 ' >
                    <img className='p-1' src={color1} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => { changeImages('blanc'); changePrix('prixBlanc'); }} />
                    <span>Peinture opaque Blanc Glacier</span><br />
                    <b>{prixBlanc} €</b>
                  </div>
                  <div className='col-4'>
                    <img className='p-1' src={color2} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => { changeImages('bleu'); changePrix('prixBleu'); }} />
                    <span>Teinte spéciale Bleu<br /> Alpine</span><br />
                    <b>{prixBleu} €</b>
                  </div>
                  <div className='col-4'>
                    <img className='p-1' src={color3} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => { changeImages('noir'); changePrix('prixNoir'); }} />
            ...
            <div className='containerNext d-flex justify-content-start align-items-center'  >
              <div className='addition' style={{ border: '2px solid black', borderRadius: '0 0 30px 0' }}>
                <ul className="ma-liste">
                  ...
                  <li>Équipements:<span className='fs-6'>{ }€</span></li>
                  <li>Accessoires:<span className='fs-6'>{ }€</span></li>
                  <hr />
              ...
              <div className='row'>
                <div className="col-md-6  container d-flex justify-content-center align-items-center ">
                  <div className='row d-flex justify-content-center align-items-center text-center  mb-5' >
                    ...
                    <div className='col-4 ' >
                      <img className='p-1' src={jant1} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => { changeJant('legend'); changePrixJant('Legend'); }} />
                      <span>Legende</span><br />
                      <b>{Legend} €</b>
                    </div>
                    <div className='col-4'>
                      <img className='p-1' src={jant2} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => { changeJant('serac'); changePrixJant('Serac'); }} />
                      <span>Serac</span><br />
                      <b>{Serac} €</b>
                    </div>
                    <div className='col-4'>
                      <img className='p-1' src={jant3} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => { changeJant('standard'); changePrixJant('Standard'); }} />
          ...
          <div className=' m-0 p-0'>
            ...
            <div className='container'>
              <div className='row'>
                <div className="col-md-6 image-container d-flex justify-content-center align-items-center">
                  <div className='d-flex flex-column justify-content-center align-items-center'>
                    <img src={currentSellerie[currentIndex]} alt={`Image ${currentIndex}`} style={{ width: '100%', height: 'auto', marginLeft: 'auto', marginRight: 'auto', zIndex: -1, border: '4px solid black', padding: '7px', marginBottom: '20px' }} />
                    <div className="container  button-container d-flex justify-content-center align-items-center" style={{ width: '20vh' }}>
                      <button onClick={prevImage} style={{ border: 'none', background: 'none', padding: '0', cursor: 'pointer' }}><IoIosArrowDropleftCircle style={{ width: '50', height: 'auto' }} /></button>
                      <Tb360View style={{ width: '50', height: 'auto', marginLeft: 'auto', marginRight: 'auto' }} /> {/* Icone pour l'effet de rotation à 360 degrés */}
                      <button onClick={nextImage} style={{ border: 'none', background: 'none', padding: '0', cursor: 'pointer' }}><IoIosArrowDroprightCircle style={{ width: '50', height: 'auto' }} /></button>
                ...
                <div className="col-md-6  container d-flex justify-content-center align-items-center ">
                  <div className='row d-flex justify-content-center align-items-center text-center  mb-5' >
                    ...
                    <div className='col-3 ' >
                      <img className='p-1' src={cuir1} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => { changeSellerie('brun'); changePrixSellerie('Dinamica'); }} />
                      <span>Sièges Confort en cuir brun</span><br />
                      <b>{Dinamica} €</b>
                    </div>
                    <div className='col-3'>
                      <img className='p-1' src={cuir4} style={{ width: '90%', height: '100px', border: '5px solid black' }} onClick={() => { changeSellerie('noir'); changePrixSellerie('Perfpre'); }} />
            ...
            <div className='container'>
              <div className='row d-flex justify-content-between align-items-center'>
                ...
                {images.map((image, index) => (
                  <div key={index} className='col-md-5 mb-3 ' style={{ border: '4px solid black', padding: '10px' }}>
                    <div className='row'>
                      <div className='col-6'>
                        <img style={{ border: '2px solid black', width: '200px', padding: '10px' }} src={image} alt={`Image ${index + 1}`} />
                      </div>
                      <div className="col-6">
                      <h1 onClick={() => showEquipmentDetails(index)}>{imagesName[index]} {openedItems[index] ? <MdOutlineKeyboardArrowUp /> : <MdOutlineKeyboardArrowDown />}</h1>
                      {openedItems[index] && (
                        <div>
                          <ul>
                            <li><img src="" /> <p>'nom'</p> <p>''</p></li>
                          </ul>
                        </div>
                         )}
                      </div>
